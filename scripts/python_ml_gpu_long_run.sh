...
CLASSIFIER_OLLAMA_BASE_URL="${CLASSIFIER_OLLAMA_BASE_URL:-http://127.0.0.1:11434}"
CLASSIFIER_REQUEST_TIMEOUT_SEC="${CLASSIFIER_REQUEST_TIMEOUT_SEC:-90}"
...
cmd=(
  ...
  --ollama-base-url "$CLASSIFIER_OLLAMA_BASE_URL"
  --request-timeout-sec "$CLASSIFIER_REQUEST_TIMEOUT_SEC"
